...
public class PaymentController {
    ...
    public ResponseEntity<?> sellCoupon(PurchaseRequestDto request, Authentication auth) {
    ...
    public ResponseEntity<?> createCoupon(CouponCreateDto coupon, Authentication auth) {
        String email = auth.getName();
        try {
