...
import com.vfortro.gestoreta.service.auth.MyUserDetailsService;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("*")); // O tu dominio
        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS"));
        configuration.setAllowedHeaders(Arrays.asList("Authorization", "Content-Type")); // <--- VITAL
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // Para manejar contraseñas encriptadas
    }
    ...
    public AuthenticationProvider authenticationProvider(MyUserDetailsService myUserDetailsService) {
        ...
        authProvider.setPasswordEncoder(passwordEncoder()); // El BCryptPasswordEncoder
        return authProvider;
    }
}
